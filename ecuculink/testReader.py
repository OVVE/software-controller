...
def process_in_serial(ser: serial.Serial):
    in_pkt={
...
def main():
    """ Script to test Reader """
    # Call the Serial Initilization Function, Main Program Starts from here
    ser = init_serial()
    process_in_serial(ser)
